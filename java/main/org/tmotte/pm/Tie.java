...
/**
 * Represents the duration of "tied" notes. The Chord class already has a {@link Chord#tie(Number)}
 * method that will do the job, but sometimes, instead of just the usual
 * half/quarter/eighth/dotted/triplet note, we want to send a tied-note duration of, say,
 * quarter + eighth, or three sixteenths, or whatever. In those (possibly rare) cases you'll need
 * Tie. Refer to test.hear.TestTies2 for an example.
 * <p>
