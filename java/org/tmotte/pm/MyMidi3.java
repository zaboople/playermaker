...
public class MyMidi3  {
	...
	public void sequenceAndWrite(File file) throws Exception {
    ...
    public void sequenceAndPlay(Player... players) throws Exception {
	    sequence(players);
	    play(true);
	}

    public void sequenceAndPlay(Player player, boolean andThenStop) throws Exception {
	    sequence(player);
	    play(andThenStop);
	}
